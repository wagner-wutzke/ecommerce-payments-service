...
class DefaultCustomerServiceTest {
  ...
  private DefaultCustomerReplicationService service;
  ...
  void setUp() {
    ...
    service = new DefaultCustomerReplicationService(customerRepository);
  }
  ...
  void insertsReplicaWhenCustomerDoesNotExist() {
    ...
    final CustomerDTO result = service.replicate(customer);
