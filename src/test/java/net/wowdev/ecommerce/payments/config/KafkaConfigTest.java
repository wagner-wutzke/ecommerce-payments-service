...
class KafkaConfigTest {
    ...
    private static void assertProducerConfiguration(final ProducerFactory<String, Object> producerFactory) {
        final MapAssertions properties = new MapAssertions(
    ...
    private static void assertConsumerConfiguration(final ConsumerFactory<String, Object> consumerFactory) {
        final MapAssertions properties = new MapAssertions(
